...
import 'registro_aborto_offline_model.dart';
export 'registro_aborto_offline_model.dart';

class RegistroAbortoOfflineWidget extends StatefulWidget {
  const RegistroAbortoOfflineWidget({
    super.key,
  ...
  @override
  State<RegistroAbortoOfflineWidget> createState() =>
      _RegistroAbortoOfflineWidgetState();
}

class _RegistroAbortoOfflineWidgetState
    extends State<RegistroAbortoOfflineWidget> with TickerProviderStateMixin {
  late RegistroAbortoOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroAbortoOfflineModel());
