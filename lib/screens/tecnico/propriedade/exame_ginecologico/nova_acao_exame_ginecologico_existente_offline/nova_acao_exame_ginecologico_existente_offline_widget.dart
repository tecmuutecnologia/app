...
import '/screens/tecnico/propriedade/exame_ginecologico/induzir_lactacao_existente_offline/induzir_lactacao_existente_offline_widget.dart';
import 'dart:ui';
...
import 'nova_acao_exame_ginecologico_existente_offline_model.dart';
export 'nova_acao_exame_ginecologico_existente_offline_model.dart';

class NovaAcaoExameGinecologicoExistenteOfflineWidget extends StatefulWidget {
  const NovaAcaoExameGinecologicoExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<NovaAcaoExameGinecologicoExistenteOfflineWidget> createState() =>
      _NovaAcaoExameGinecologicoExistenteOfflineWidgetState();
}

class _NovaAcaoExameGinecologicoExistenteOfflineWidgetState
    extends State<NovaAcaoExameGinecologicoExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late NovaAcaoExameGinecologicoExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => NovaAcaoExameGinecologicoExistenteOfflineModel());
                                ...
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child:
                                          InduzirLactacaoExistenteOfflineWidget(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if ((_model.acoesDispoValue != null &&
                                  ...
                                  safeSetState(() {});
                                  if (FFAppState().resumoDaVisita.length > 0) {
                                    FFAppState()
                                        .addToTratamentos(TratamentosStruct(
                                      uidAnimal: widget.uidAnimaisProdutores,
                                      tipoAcao: _model.acoesDispoValue,
                                      observacaoAcao:
                                          _model.obsInfoTextController.text,
                                    ...
                                    safeSetState(() {});
                                    FFAppState()
                                        .addToRecomendacoes(RecomendacoesStruct(
                                      tituloRecomendacao:
                                          _model.acoesDispoValue,
                                    ...
                                    FFAppState().addToResumoDaVisita(
