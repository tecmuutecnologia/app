...
import '/screens/tecnico/propriedade/exame_ginecologico/induzir_lactacao_offline/induzir_lactacao_offline_widget.dart';
import 'dart:ui';
...
import 'nova_acao_exame_ginecologico_offline_model.dart';
export 'nova_acao_exame_ginecologico_offline_model.dart';

class NovaAcaoExameGinecologicoOfflineWidget extends StatefulWidget {
  const NovaAcaoExameGinecologicoOfflineWidget({
    super.key,
  ...
  @override
  State<NovaAcaoExameGinecologicoOfflineWidget> createState() =>
      _NovaAcaoExameGinecologicoOfflineWidgetState();
}

class _NovaAcaoExameGinecologicoOfflineWidgetState
    extends State<NovaAcaoExameGinecologicoOfflineWidget>
    with TickerProviderStateMixin {
  late NovaAcaoExameGinecologicoOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => NovaAcaoExameGinecologicoOfflineModel());
                    ...
                    children: [
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 16.0, 12.0),
                                    suffixIcon: _model.dtAcaoTextController!
                                            .text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.dtAcaoTextController
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.obsInfoTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ],
                                ...
                                await showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: InduzirLactacaoOfflineWidget(
                                        ...
                                        brincoAnimal: FFAppState()
                                            ...
                                            .brincoAnimal
                                            .toString(),
                                        itemUidIndex: widget.itemUidIndex!,
                                        uidAnimalOffline:
                                            widget.uidAnimalOffline!,
                                      ),
                                    );
                                  },
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if ((_model.acoesDispoValue != null &&
                                  ...
                                  (_model.dtAcaoTextController.text != '')) {
                                // No obsVisita está sendo passado a posição do animal do array devido o mesmo não ter ainda um UID por não ter um cadastro online. Na hora de sincronizar os dados este animal não terá nada no campo uidAnimal e no campo obsVisita terá apenas um id ou seja a posição do array para saber de qual animal se trata.
                                FFAppState().addToAcoesOffline(AcoesStruct(
                                  ...
                                  uidAnimalOffline: widget.uidAnimalOffline,
