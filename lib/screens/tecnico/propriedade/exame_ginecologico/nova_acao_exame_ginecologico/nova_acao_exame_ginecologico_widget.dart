...
import '/screens/tecnico/propriedade/exame_ginecologico/induzir_lactacao/induzir_lactacao_widget.dart';
import 'dart:ui';
...
class NovaAcaoExameGinecologicoWidget extends StatefulWidget {
  ...
  @override
  State<NovaAcaoExameGinecologicoWidget> createState() =>
      _NovaAcaoExameGinecologicoWidgetState();
}
                              ...
                              if ((_model.acoesDispoValue != null &&
                                ...
                                if (_model.outUidResumoDaVisita != null) {
                                  await TratamentosRecord.createDoc(_model
                                    ...
                                    uidAcaoLancada:
                                        _model.uidAcaoLancada?.reference,
                                    brincoAnimalOrder:
