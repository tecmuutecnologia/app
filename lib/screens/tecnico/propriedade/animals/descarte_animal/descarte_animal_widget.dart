...
class DescarteAnimalWidget extends StatefulWidget {
  ...
  @override
  State<DescarteAnimalWidget> createState() => _DescarteAnimalWidgetState();
}
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            24.0, 16.0, 16.0, 0.0),
                        child: Text(
                          'Deseja realmente descartar o animal ${widget.nomeAnimal}?',
                          style:
                        ...
                        child: StreamBuilder<List<AnimaisProdutoresRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<AnimaisProdutoresRecord>
                                motivoDescarteAnimaisProdutoresRecordList =
                                snapshot.data!;

                            return FlutterFlowDropDown<String>(
                              controller:
                                  _model.motivoDescarteValueController ??=
                              ...
                              onChanged: (val) => safeSetState(
                                  () => _model.motivoDescarteValue = val),
                              width: double.infinity,
                              height: 60.0,
                    ...
                    children: [
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.dtDescarteTextControllerValidator
                              .asValidator(context),
                              ...
                              if (_model.dtDescarteTextController.text != '') {
                                var confirmDialogResponse =
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text(
                                                  'Essa ação não eliminará o animal da propriedade.'),
                                              content: Text(
                                                  'Irá ser movido para a aba de \"Descarte\".'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                ...
                                if (confirmDialogResponse) {
                                  await _model.outUidAnimaisAnimal!.reference
                                    ...
                                    status: 'Descarte',
                                    dtDescarteAnimal:
                                        _model.dtDescarteTextController.text,
                                    motivoDescarteAnimal:
                                        _model.motivoDescarteValue,
                                  ));
                                  Navigator.pop(context);
                                  return;
                                } else {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Informe a data da baixa.'),
