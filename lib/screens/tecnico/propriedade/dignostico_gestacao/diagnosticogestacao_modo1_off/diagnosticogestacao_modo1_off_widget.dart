...
import '/screens/tecnico/propriedade/dignostico_gestacao/confirma_pp/confirma_pp_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/confirma_pp_existente_offline/confirma_pp_existente_offline_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/confirma_pp_offline/confirma_pp_offline_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_mais/dg_mais_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_mais_existente_offline/dg_mais_existente_offline_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_mais_offline/dg_mais_offline_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_menos/dg_menos_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_menos_existente_offline/dg_menos_existente_offline_widget.dart';
import '/screens/tecnico/propriedade/dignostico_gestacao/dg_menos_offline/dg_menos_offline_widget.dart';
...
import 'diagnosticogestacao_modo1_off_model.dart';
export 'diagnosticogestacao_modo1_off_model.dart';

class DiagnosticogestacaoModo1OffWidget extends StatefulWidget {
  const DiagnosticogestacaoModo1OffWidget({
    super.key,
  ...
  static String routeName = 'diagnosticogestacaoModo1Off';
  static String routePath = '/diagnosticogestacaoModo1Off';

  @override
  State<DiagnosticogestacaoModo1OffWidget> createState() =>
      _DiagnosticogestacaoModo1OffWidgetState();
}

class _DiagnosticogestacaoModo1OffWidgetState
    extends State<DiagnosticogestacaoModo1OffWidget> {
  late DiagnosticogestacaoModo1OffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiagnosticogestacaoModo1OffModel());
