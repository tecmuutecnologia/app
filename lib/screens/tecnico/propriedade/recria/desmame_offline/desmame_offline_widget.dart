...
import 'desmame_offline_model.dart';
export 'desmame_offline_model.dart';

class DesmameOfflineWidget extends StatefulWidget {
  ...
  @override
  State<DesmameOfflineWidget> createState() => _DesmameOfflineWidgetState();
}

class _DesmameOfflineWidgetState extends State<DesmameOfflineWidget>
    with TickerProviderStateMixin {
  late DesmameOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesmameOfflineModel());
