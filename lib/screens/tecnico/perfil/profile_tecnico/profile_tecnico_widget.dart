                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      buildCounter: (context,
                              ...
                              maxLength}) =>
                          null,
                      validator: _model.empresaTextControllerValidator
                          .asValidator(context),
                      inputFormatters: [
                        if (!isAndroid && !isiOS)
                          TextInputFormatter.withFunction((oldValue, newValue) {
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 16.0),
                    child: TextFormField(
                      controller: _model.dtTextController ??=
                          TextEditingController(
                      ...
                      validator:
                          _model.dtTextControllerValidator.asValidator(context),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (profileTecnicoPersonRecord?.uid ==
                              currentUserUid) {
