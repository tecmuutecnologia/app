  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PersonRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PersonRecord> apagarContaPersonRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final apagarContaPersonRecord = apagarContaPersonRecordList.isNotEmpty
            ? apagarContaPersonRecordList.first
            : null;
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Ao confirmar a exclusão da conta,\nserá eliminado por completo todas\nas informações do sistema.\nImpossibilitando assim a restauração da conta.\nEssa ação irá apagar:\n- Dados pessoais da conta;\n- Produtores cadastrados e seus ativos;\n- Assinatura do plano;',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (confirmDialogResponse) {
                          await apagarContaPersonRecord!.reference.delete();
