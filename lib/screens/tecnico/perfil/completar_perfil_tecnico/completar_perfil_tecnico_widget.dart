                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.dtnascimentoTextController,
                                          focusNode:
                                              _model.dtnascimentoFocusNode,
                                          autofocus: true,
                                          textCapitalization:
                                              TextCapitalization.none,
                                          obscureText: false,
                                          ...
                                          keyboardType: TextInputType.number,
                                          validator: _model
                                              .dtnascimentoTextControllerValidator
                                              .asValidator(context),
                                          inputFormatters: [
                                            _model.dtnascimentoMask
                                          ],
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          buildCounter: (context,
                                              ...
                                              null,
                                          validator: _model
                                              .cidadeufTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<PlanosTecnicosRecord>
                                                btnAvancarPlanosTecnicosRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            ...
                                            return FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                if (_model.outUidPersonExists !=
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text(
                                                            'CPF informado já possui um cadastro.'),
                                                        content: Text(
                                                            'Informe outro CPF para continuar.'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                                ...
                                                await completarPerfilTecnicoPersonRecord!
                                                    .reference
                                                    .update(
                                                        createPersonRecordData(
                                                  dtNascimento: _model
                                                      .dtnascimentoTextController
                                                      .text,
                                                  cpf: _model
                                                      .cpfTextController.text,
                                                  endereco: _model
                                                  ...
                                                  phoneNumber: _model
                                                      ...
                                                      .text,
                                                  empresa: _model
                                                      .empresaTextController
                                                      .text,
                                                ));

                                                var tecnicoRecordReference =
                                                    TecnicoRecord.collection
                                                        .doc();
                                                await tecnicoRecordReference
                                                    .set(
                                                        createTecnicoRecordData(
                                                  uidPerson:
                                                      completarPerfilTecnicoPersonRecord
                                                          .reference.id,
                                                  liberado: true,
                                                ...
                                                _model.outUidTecnico = TecnicoRecord
                                                    .getDocumentFromData(
                                                        createTecnicoRecordData(
                                                          uidPerson:
                                                              completarPerfilTecnicoPersonRecord
                                                ...
                                                await assinaturaTecnicoRecordReference
                                                  ...
                                                  idTecnico: _model
                                                      .outUidTecnico?.reference,
                                                  idPlano:
                                                      btnAvancarPlanosTecnicosRecord
                                                          ?.reference,
                                                  dtAssinatura:
                                                      getCurrentTimestamp,
                                                  dtExpiracao:
                                                ...
                                                await AssinaturaAtivaTecnicoRecord
                                                    .collection
                                                    .doc()
                                                    .set(
