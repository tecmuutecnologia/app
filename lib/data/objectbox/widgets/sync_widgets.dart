...
/// Widget de progresso de sincronização inicial
class InitialSyncProgressWidget extends StatelessWidget {
  final Stream<SyncProgress> progressStream;
  final VoidCallback? onRetry;
  final VoidCallback? onSkip;

  const InitialSyncProgressWidget({
    super.key,
          ...
          child: Column(
            ...
            children: [
              ...
              if (onSkip != null)
                TextButton(
                  onPressed: onSkip,
                  child: const Text('Usar dados locais existentes'),
                ),
            ],
          ),
        );
