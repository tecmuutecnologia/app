...
import 'nova_inseminacao_existente_offline_model.dart';
export 'nova_inseminacao_existente_offline_model.dart';

class NovaInseminacaoExistenteOfflineWidget extends StatefulWidget {
  const NovaInseminacaoExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<NovaInseminacaoExistenteOfflineWidget> createState() =>
      _NovaInseminacaoExistenteOfflineWidgetState();
}

class _NovaInseminacaoExistenteOfflineWidgetState
    extends State<NovaInseminacaoExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late NovaInseminacaoExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovaInseminacaoExistenteOfflineModel());
                                  ...
                                  if (widget.dtUltimaInseminacao != null &&
                                    ...
                                    FFAppState().addToAnimaisProdutoresEditados(
                                      ...
                                      dtUltimaAcao: FFAppState()
                                          ...
                                          ?.dtUltimaAcao,
                                      compararDtUltimaInseminacao: functions
                                          .converterDataUltimaInseminacao(_model
                                              .dtInseminacaoTextController
                                              .text),
                                      nomeBrincoConcat: FFAppState()
                                          .animaisProdutoresExistentes
