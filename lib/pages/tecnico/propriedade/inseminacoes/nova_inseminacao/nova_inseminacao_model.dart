...
class NovaInseminacaoModel extends FlutterFlowModel<NovaInseminacaoWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Read Document] action in novaInseminacao widget.
