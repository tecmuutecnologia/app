...
import 'nova_inseminacao_offline_model.dart';
export 'nova_inseminacao_offline_model.dart';

class NovaInseminacaoOfflineWidget extends StatefulWidget {
  const NovaInseminacaoOfflineWidget({
    super.key,
  ...
  @override
  State<NovaInseminacaoOfflineWidget> createState() =>
      _NovaInseminacaoOfflineWidgetState();
}

class _NovaInseminacaoOfflineWidgetState
    extends State<NovaInseminacaoOfflineWidget> with TickerProviderStateMixin {
  late NovaInseminacaoOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovaInseminacaoOfflineModel());
