...
import 'registrar_cio_existente_offline_model.dart';
export 'registrar_cio_existente_offline_model.dart';

class RegistrarCioExistenteOfflineWidget extends StatefulWidget {
  const RegistrarCioExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarCioExistenteOfflineWidget> createState() =>
      _RegistrarCioExistenteOfflineWidgetState();
}

class _RegistrarCioExistenteOfflineWidgetState
    extends State<RegistrarCioExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late RegistrarCioExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrarCioExistenteOfflineModel());
