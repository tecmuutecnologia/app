...
import 'lista_inseminacoes_bkp_dez_model.dart';
export 'lista_inseminacoes_bkp_dez_model.dart';

class ListaInseminacoesBkpDezWidget extends StatefulWidget {
  const ListaInseminacoesBkpDezWidget({
    super.key,
  ...
  static String routeName = 'listaInseminacoesBkpDez';
  static String routePath = '/listaInseminacoesBkpDez';

  @override
  State<ListaInseminacoesBkpDezWidget> createState() =>
      _ListaInseminacoesBkpDezWidgetState();
}

class _ListaInseminacoesBkpDezWidgetState
    extends State<ListaInseminacoesBkpDezWidget> {
  late ListaInseminacoesBkpDezModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaInseminacoesBkpDezModel());
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, listaAnimaisOfflineIndex) {
                        final listaAnimaisOfflineItem =
                            listaAnimaisOffline[listaAnimaisOfflineIndex];
                        return Visibility(
