...
class RegistrarPartoModel extends FlutterFlowModel<RegistrarPartoWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Read Document] action in registrarParto widget.
