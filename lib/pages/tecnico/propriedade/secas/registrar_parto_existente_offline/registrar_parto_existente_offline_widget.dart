...
import 'registrar_parto_existente_offline_model.dart';
export 'registrar_parto_existente_offline_model.dart';

class RegistrarPartoExistenteOfflineWidget extends StatefulWidget {
  const RegistrarPartoExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarPartoExistenteOfflineWidget> createState() =>
      _RegistrarPartoExistenteOfflineWidgetState();
}

class _RegistrarPartoExistenteOfflineWidgetState
    extends State<RegistrarPartoExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late RegistrarPartoExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrarPartoExistenteOfflineModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              cursorColor: FlutterFlowTheme.of(context).primary,
                              validator: _model.brincoTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              ...
                              options:
                                  List<String>.from(['Bezerras', 'Bezerros']),
                              optionLabels: [
                                'Feminino (Bezerra)',
                                'Masculino (Bezerro)'
                              ],
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<RacasRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<RacasRecord> racaPreRacasRecordList =
                                    snapshot.data!;
                                ...
                                return FlutterFlowDropDown<String>(
                                  ...
                                  options: racaPreRacasRecordList
                                      .map((e) => e.descricao)
                                      .toList(),
                                  onChanged: (val) => safeSetState(
                                      () => _model.racaPreValue = val),
                                  width: double.infinity,
                                  height: 58.0,
                                  searchHintTextStyle:
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: _model
                                          .dtPartoTextControllerValidator
                                          .asValidator(context),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              cursorColor: FlutterFlowTheme.of(context).primary,
                              validator: _model.pesoNascTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: Material(
                              ...
                              child: SwitchListTile.adaptive(
                                ...
                                onChanged: (newValue) async {
                                  safeSetState(
                                      () => _model.novoAnimalValue = newValue);
                                },
                                title: Text(
