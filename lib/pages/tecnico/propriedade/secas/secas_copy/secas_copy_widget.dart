...
import 'secas_copy_model.dart';
export 'secas_copy_model.dart';

class SecasCopyWidget extends StatefulWidget {
  const SecasCopyWidget({
    super.key,
  ...
  static String routeName = 'secasCopy';
  static String routePath = '/secasCopy';

  @override
  State<SecasCopyWidget> createState() => _SecasCopyWidgetState();
}

class _SecasCopyWidgetState extends State<SecasCopyWidget>
    with TickerProviderStateMixin {
  late SecasCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecasCopyModel());
                                                                ...
                                                                return GestureDetector(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      brincoVacaAtual: listViewAnimaisProdutoresRecord
                                                                          .brincoAnimal
                                                                          .toString(),
                                                                    ),
                                                                  ),
                                                              ...
                                                              return GestureDetector(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    dtPrePartoPrevista:
                                                                        functions
                                                                            .converteDataStringDate(listViewAnimaisProdutoresRecord.dtPrePartoPrevista),
                                                                  ),
                                                                ),
                                                              );
                                                            },
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Indução lactação: ${listViewAnimaisProdutoresRecord.dtPartoPrevisto}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
                                                              .override(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      uidAnimaisProdutores:
                                                                          listViewAnimaisProdutoresRecord
                                                                              .reference,
                                                                      nomeAnimal: listViewAnimaisProdutoresRecord.nomeAnimal !=
                                                                                  ''
                                                                          ? listViewAnimaisProdutoresRecord
                                                                              .nomeAnimal
                                                                          : listViewAnimaisProdutoresRecord
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Data do descarte: ${listViewAnimaisProdutoresRecord.dtDescarteAnimal}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Motivo: ${listViewAnimaisProdutoresRecord.motivoDescarteAnimal}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .labelMedium
                                                            ...
                                                            var confirmDialogResponse =
                                                                await showDialog<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Deseja realmente restaurar  o animal?'),
                                                                          content:
                                                                              Text('Ele voltará para a lista do rebanho com o status vazia.'),
                                                                          actions: [
                                                                            TextButton(
