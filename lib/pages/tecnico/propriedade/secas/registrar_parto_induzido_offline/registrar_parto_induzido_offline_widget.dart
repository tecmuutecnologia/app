...
import 'registrar_parto_induzido_offline_model.dart';
export 'registrar_parto_induzido_offline_model.dart';

class RegistrarPartoInduzidoOfflineWidget extends StatefulWidget {
  const RegistrarPartoInduzidoOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarPartoInduzidoOfflineWidget> createState() =>
      _RegistrarPartoInduzidoOfflineWidgetState();
}

class _RegistrarPartoInduzidoOfflineWidgetState
    extends State<RegistrarPartoInduzidoOfflineWidget>
    with TickerProviderStateMixin {
  late RegistrarPartoInduzidoOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrarPartoInduzidoOfflineModel());
