...
import 'registrar_pre_parto_offline_model.dart';
export 'registrar_pre_parto_offline_model.dart';

class RegistrarPrePartoOfflineWidget extends StatefulWidget {
  const RegistrarPrePartoOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarPrePartoOfflineWidget> createState() =>
      _RegistrarPrePartoOfflineWidgetState();
}

class _RegistrarPrePartoOfflineWidgetState
    extends State<RegistrarPrePartoOfflineWidget>
    with TickerProviderStateMixin {
  late RegistrarPrePartoOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrarPrePartoOfflineModel());
