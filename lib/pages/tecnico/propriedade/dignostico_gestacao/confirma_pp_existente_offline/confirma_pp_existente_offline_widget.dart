...
import 'confirma_pp_existente_offline_model.dart';
export 'confirma_pp_existente_offline_model.dart';

class ConfirmaPpExistenteOfflineWidget extends StatefulWidget {
  const ConfirmaPpExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<ConfirmaPpExistenteOfflineWidget> createState() =>
      _ConfirmaPpExistenteOfflineWidgetState();
}

class _ConfirmaPpExistenteOfflineWidgetState
    extends State<ConfirmaPpExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late ConfirmaPpExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmaPpExistenteOfflineModel());
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 16.0, 12.0),
                                    suffixIcon: _model
                                            .dtPPTextController!.text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.dtPPTextController
                                                  ?.clear();
                                  ...
                                  validator: _model.dtPPTextControllerValidator
                                      .asValidator(context),
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                safeSetState(() {
                                  _model.dtPPTextController?.text =
                                      dateTimeFormat(
                                    "dd/MM/yyyy",
                                    _model.datePicked,
