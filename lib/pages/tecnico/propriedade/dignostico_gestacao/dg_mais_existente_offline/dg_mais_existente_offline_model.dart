...
import 'dg_mais_existente_offline_widget.dart'
    show DgMaisExistenteOfflineWidget;
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class DgMaisExistenteOfflineModel
    extends FlutterFlowModel<DgMaisExistenteOfflineWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Backend Call - Read Document] action in dgMaisExistenteOffline widget.
