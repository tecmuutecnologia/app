...
import 'dg_menos_offline_model.dart';
export 'dg_menos_offline_model.dart';

class DgMenosOfflineWidget extends StatefulWidget {
  const DgMenosOfflineWidget({
    super.key,
  ...
  @override
  State<DgMenosOfflineWidget> createState() => _DgMenosOfflineWidgetState();
}

class _DgMenosOfflineWidgetState extends State<DgMenosOfflineWidget>
    with TickerProviderStateMixin {
  late DgMenosOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DgMenosOfflineModel());
