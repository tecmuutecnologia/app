...
import 'confirma_pp_offline_model.dart';
export 'confirma_pp_offline_model.dart';

class ConfirmaPpOfflineWidget extends StatefulWidget {
  const ConfirmaPpOfflineWidget({
    super.key,
  ...
  @override
  State<ConfirmaPpOfflineWidget> createState() =>
      _ConfirmaPpOfflineWidgetState();
}

class _ConfirmaPpOfflineWidgetState extends State<ConfirmaPpOfflineWidget>
    with TickerProviderStateMixin {
  late ConfirmaPpOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmaPpOfflineModel());
