...
import 'dg_menos_existente_offline_model.dart';
export 'dg_menos_existente_offline_model.dart';

class DgMenosExistenteOfflineWidget extends StatefulWidget {
  const DgMenosExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<DgMenosExistenteOfflineWidget> createState() =>
      _DgMenosExistenteOfflineWidgetState();
}

class _DgMenosExistenteOfflineWidgetState
    extends State<DgMenosExistenteOfflineWidget> with TickerProviderStateMixin {
  late DgMenosExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DgMenosExistenteOfflineModel());
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 16.0, 12.0),
                                    suffixIcon: _model.dtDgMenosTextController!
                                            .text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.dtDgMenosTextController
                                  ...
                                  validator: _model
                                      .dtDgMenosTextControllerValidator
                                      .asValidator(context),
