...
import 'dg_mais_offline_model.dart';
export 'dg_mais_offline_model.dart';

class DgMaisOfflineWidget extends StatefulWidget {
  const DgMaisOfflineWidget({
    super.key,
  ...
  @override
  State<DgMaisOfflineWidget> createState() => _DgMaisOfflineWidgetState();
}

class _DgMaisOfflineWidgetState extends State<DgMaisOfflineWidget>
    with TickerProviderStateMixin {
  late DgMaisOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DgMaisOfflineModel());
