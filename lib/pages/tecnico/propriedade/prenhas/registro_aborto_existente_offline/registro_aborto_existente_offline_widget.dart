...
import 'registro_aborto_existente_offline_model.dart';
export 'registro_aborto_existente_offline_model.dart';

class RegistroAbortoExistenteOfflineWidget extends StatefulWidget {
  const RegistroAbortoExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<RegistroAbortoExistenteOfflineWidget> createState() =>
      _RegistroAbortoExistenteOfflineWidgetState();
}

class _RegistroAbortoExistenteOfflineWidgetState
    extends State<RegistroAbortoExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late RegistroAbortoExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroAbortoExistenteOfflineModel());
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding:
                                        EdgeInsetsDirectional.fromSTEB(
                                            16.0, 12.0, 16.0, 12.0),
                                    suffixIcon: _model.dtAbortoTextController!
                                            .text.isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                                              _model.dtAbortoTextController
                                  ...
                                  validator: _model
                                      .dtAbortoTextControllerValidator
                                      .asValidator(context),
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                safeSetState(() {
                                  _model.dtAbortoTextController?.text =
                                      dateTimeFormat(
                                    "dd/MM/yyyy",
                                    _model.datePicked,
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model.dtAbortoTextController.text != '') {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Data do abordo vazia.'),
                              ...
                              if (FFAppState()
                                ...
                                if (FFAppState().verificadorIgualdade == 0) {
                                  FFAppState()
                                      .updateAnimaisProdutoresExistentesAtIndex(
                                    widget.itemUidIndex!,
                                    (e) => e
