...
import 'animais_prenhas_bkp_recente_model.dart';
export 'animais_prenhas_bkp_recente_model.dart';

class AnimaisPrenhasBkpRecenteWidget extends StatefulWidget {
  const AnimaisPrenhasBkpRecenteWidget({
    super.key,
  ...
  static String routeName = 'animaisPrenhasBkpRecente';
  static String routePath = '/animaisPrenhasBkpRecente';

  @override
  State<AnimaisPrenhasBkpRecenteWidget> createState() =>
      _AnimaisPrenhasBkpRecenteWidgetState();
}

class _AnimaisPrenhasBkpRecenteWidgetState
    extends State<AnimaisPrenhasBkpRecenteWidget> {
  late AnimaisPrenhasBkpRecenteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnimaisPrenhasBkpRecenteModel());
