...
import 'registrar_secagem_offline_model.dart';
export 'registrar_secagem_offline_model.dart';

class RegistrarSecagemOfflineWidget extends StatefulWidget {
  const RegistrarSecagemOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarSecagemOfflineWidget> createState() =>
      _RegistrarSecagemOfflineWidgetState();
}

class _RegistrarSecagemOfflineWidgetState
    extends State<RegistrarSecagemOfflineWidget> with TickerProviderStateMixin {
  late RegistrarSecagemOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrarSecagemOfflineModel());
