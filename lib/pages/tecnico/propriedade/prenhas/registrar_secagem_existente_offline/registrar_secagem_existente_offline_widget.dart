...
import 'registrar_secagem_existente_offline_model.dart';
export 'registrar_secagem_existente_offline_model.dart';

class RegistrarSecagemExistenteOfflineWidget extends StatefulWidget {
  const RegistrarSecagemExistenteOfflineWidget({
    super.key,
  ...
  @override
  State<RegistrarSecagemExistenteOfflineWidget> createState() =>
      _RegistrarSecagemExistenteOfflineWidgetState();
}

class _RegistrarSecagemExistenteOfflineWidgetState
    extends State<RegistrarSecagemExistenteOfflineWidget>
    with TickerProviderStateMixin {
  late RegistrarSecagemExistenteOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => RegistrarSecagemExistenteOfflineModel());
