...
class PronAbortosWidget extends StatefulWidget {
  ...
  static String routeName = 'pronAbortos';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AnimaisProdutoresRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final pronAbortosAnimaisProdutoresRecord = snapshot.data!;
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return Visibility(
                                      visible:
                                          listViewAcoesRecord.acao == 'Aborto',
                                      child: Card(
                                        clipBehavior:
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, acoesAbortosIndex) {
