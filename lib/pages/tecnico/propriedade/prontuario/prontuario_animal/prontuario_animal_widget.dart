                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        () {
                                          if ((prontuarioAnimalAnimaisProdutoresRecord
                                                      .nomeAnimal !=
                                                  '') &&
                                            ...
                                            return '${prontuarioAnimalAnimaisProdutoresRecord.nomeAnimal} - ${prontuarioAnimalAnimaisProdutoresRecord.brincoAnimal.toString()}';
                                                  ...
                                                  .nomeAnimal !=
                                              '') {
                                            return prontuarioAnimalAnimaisProdutoresRecord
                                                .nomeAnimal;
                                          } else {
                                            return prontuarioAnimalAnimaisProdutoresRecord
                                                .brincoAnimal
                              ...
                              children: [
                                StreamBuilder<List<AcoesRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<AcoesRecord> listViewAcoesRecordList =
                                        snapshot.data!;
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: acoesInseminacoes.length,
                                      itemBuilder:
                                          (context, acoesInseminacoesIndex) {
                                        final acoesInseminacoesItem =
                                            acoesInseminacoes[
                                                acoesInseminacoesIndex];
                                        return Visibility(
                                          visible: (acoesInseminacoesItem
                                                      .uidAnimalAnimaisProdutores ==
                                                  widget
                                                      .uidAnimaisProdutores) &&
                                              (acoesInseminacoesItem
                                                      .uidPropriedade ==
                                                  widget.uidPropriedade) &&
                                              (acoesInseminacoesItem.acao ==
                                                  'Inseminada'),
                                          child: Card(
                                            clipBehavior:
                                                Clip.antiAliasWithSaveLayer,
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewAcoesRecord =
                                            listViewAcoesRecordList[
                                                listViewIndex];
                                        return Visibility(
                                          visible: (listViewAcoesRecord.acao !=
                                                  'Inseminada') &&
                                          ...
                                          child: InkWell(
                                            ...
                                            onLongPress: () async {
                                              ...
                                              if (confirmDialogResponse) {
                                                _model.deleteAcaoUidTratamentos =
                                                    await queryTratamentosRecordOnce(
                                                  queryBuilder:
                                                      (tratamentosRecord) =>
                                                          tratamentosRecord
                                                              .where(
                                                ...
                                                await _model
                                                    .deleteAcaoUidTratamentos!
                                                    .reference
                                                    .delete();
                                                await listViewAcoesRecord
                                                    .reference
                                                    .delete();
                                                if (_shouldSetState)
                                                  safeSetState(() {});
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, acoesGeraisIndex) {
                                        ...
                                        return Visibility(
                                          visible: (acoesGeraisItem
                                                  ...
                                                  widget
                                                      .uidAnimaisProdutores) &&
                                              (acoesGeraisItem.uidPropriedade ==
                                                  widget.uidPropriedade) &&
                                              (acoesGeraisItem.acao !=
                                                  'Inseminada') &&
                                              (acoesGeraisItem.acao != 'Cio') &&
                                              (acoesGeraisItem.acao != 'PP') &&
                                              (acoesGeraisItem.acao != 'DG+') &&
                                              (acoesGeraisItem.acao != 'DG-') &&
                                              (acoesGeraisItem.acao !=
                                                  'Inseminada PP'),
                                          child: InkWell(
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        final acoesAbortosItem =
                                            acoesAbortos[acoesAbortosIndex];
                                        return Visibility(
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, acoesDGIndex) {
                                        final acoesDGItem =
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, acoesCioIndex) {
                                        final acoesCioItem =
                                        ...
                                        return Visibility(
                                          visible: (acoesCioItem
                                                  ...
                                                  widget
                                                      .uidAnimaisProdutores) &&
                                              (acoesCioItem.uidPropriedade ==
                                                  widget.uidPropriedade) &&
                                              (acoesCioItem.acao == 'Cio'),
                                          child: Card(
                                            clipBehavior:
                                                Clip.antiAliasWithSaveLayer,
                                            color: FlutterFlowTheme.of(context)
                                ...
                                StreamBuilder<List<AcoesSanitarioRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<AcoesSanitarioRecord>
                                        listViewAcoesSanitarioRecordList =
                                        snapshot.data!;
