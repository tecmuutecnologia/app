...
import 'cadastrar_novo_animal_copy_model.dart';
export 'cadastrar_novo_animal_copy_model.dart';

class CadastrarNovoAnimalCopyWidget extends StatefulWidget {
  const CadastrarNovoAnimalCopyWidget({
    super.key,
  ...
  static String routeName = 'cadastrarNovoAnimalCopy';
  static String routePath = '/cadastrarNovoAnimalCopy';

  @override
  State<CadastrarNovoAnimalCopyWidget> createState() =>
      _CadastrarNovoAnimalCopyWidgetState();
}

class _CadastrarNovoAnimalCopyWidgetState
    extends State<CadastrarNovoAnimalCopyWidget> {
  late CadastrarNovoAnimalCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastrarNovoAnimalCopyModel());
    ...
    return StreamBuilder<List<StatusAnimaisRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<StatusAnimaisRecord>
            cadastrarNovoAnimalCopyStatusAnimaisRecordList = snapshot.data!;
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: () {
                                      if ((_model.dataUltimaInseminacaoTextController.text != '') &&
                                          ...
                                          (_model.datePicked2! >
                                              _model.datePicked3!)) {
                                        return cadastrarNovoAnimalCopyStatusAnimaisRecordList
                                            .map((e) => e.descricao)
                                            .toList()
                                            .where((e) => e == 'Vazia')
                                            .toList();
