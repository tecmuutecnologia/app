...
import 'lista_animais_copy3_model.dart';
export 'lista_animais_copy3_model.dart';

class ListaAnimaisCopy3Widget extends StatefulWidget {
  const ListaAnimaisCopy3Widget({
    super.key,
  ...
  static String routeName = 'listaAnimaisCopy3';
  static String routePath = '/listaAnimaisCopy3';

  @override
  State<ListaAnimaisCopy3Widget> createState() =>
      _ListaAnimaisCopy3WidgetState();
}

class _ListaAnimaisCopy3WidgetState extends State<ListaAnimaisCopy3Widget>
    with TickerProviderStateMixin {
  late ListaAnimaisCopy3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaAnimaisCopy3Model());
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      context
                                                                        ...
                                                                        queryParameters:
                                                                          ...
                                                                          'grupoPredominante':
                                                                              serializeParam(
                                                                            animaisProdutoresItem.grupoAnimal,
                                                                            ParamType.String,
                                                                          ),
                                                                          'visitaPresencial':
                                                                              serializeParam(
