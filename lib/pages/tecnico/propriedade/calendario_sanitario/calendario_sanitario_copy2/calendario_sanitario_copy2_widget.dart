...
import 'calendario_sanitario_copy2_model.dart';
export 'calendario_sanitario_copy2_model.dart';

class CalendarioSanitarioCopy2Widget extends StatefulWidget {
  const CalendarioSanitarioCopy2Widget({
    super.key,
  ...
  static String routeName = 'calendarioSanitarioCopy2';
  static String routePath = '/calendarioSanitarioCopy2';

  @override
  State<CalendarioSanitarioCopy2Widget> createState() =>
      _CalendarioSanitarioCopy2WidgetState();
}

class _CalendarioSanitarioCopy2WidgetState
    extends State<CalendarioSanitarioCopy2Widget> {
  late CalendarioSanitarioCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalendarioSanitarioCopy2Model());
