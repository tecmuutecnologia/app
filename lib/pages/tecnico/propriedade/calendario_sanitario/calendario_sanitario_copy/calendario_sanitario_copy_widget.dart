...
import 'calendario_sanitario_copy_model.dart';
export 'calendario_sanitario_copy_model.dart';

class CalendarioSanitarioCopyWidget extends StatefulWidget {
  const CalendarioSanitarioCopyWidget({
    super.key,
  ...
  static String routeName = 'calendarioSanitarioCopy';
  static String routePath = '/calendarioSanitarioCopy';

  @override
  State<CalendarioSanitarioCopyWidget> createState() =>
      _CalendarioSanitarioCopyWidgetState();
}

class _CalendarioSanitarioCopyWidgetState
    extends State<CalendarioSanitarioCopyWidget> {
  late CalendarioSanitarioCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalendarioSanitarioCopyModel());
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        () {
                                          if ((listaAcoesAcoesSanitarioRecord
                                                          .nomeAnimal !=
                                                      '') &&
                                              (listaAcoesAcoesSanitarioRecord
                                                          .brincoAnimal !=
                                                      '')) {
                                            return '${listaAcoesAcoesSanitarioRecord.nomeAnimal} - ${listaAcoesAcoesSanitarioRecord.brincoAnimal}';
                                          } else if (listaAcoesAcoesSanitarioRecord
                                                      .nomeAnimal !=
                                                  '') {
                                            return listaAcoesAcoesSanitarioRecord
                                                .nomeAnimal;
                                          } else {
                                            return listaAcoesAcoesSanitarioRecord
                                                .brincoAnimal;
