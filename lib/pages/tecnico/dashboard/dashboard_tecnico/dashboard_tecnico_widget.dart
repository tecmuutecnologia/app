  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TecnicoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TecnicoRecord> dashboardTecnicoTecnicoRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dashboardTecnicoTecnicoRecord =
            dashboardTecnicoTecnicoRecordList.isNotEmpty
                ? dashboardTecnicoTecnicoRecordList.first
                : null;
