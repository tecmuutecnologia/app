...
class FirebaseAuthManager extends AuthManager
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Ops! Houve um erro de autenticação. Por favor, verifique suas credenciais e tente novamente. Se o problema persistir, entre em contato conosco. [error] Mensagem do servidor.'
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(
              'A mensagem para redefinição de senha foi enviada com sucesso! Por favor, verifique a sua caixa de entrada, incluindo a pasta de spam ou lixo eletrônico, e siga as instruções para redefinir a sua senha. Se não receber o e-mail dentro de alguns minutos, verifique se digitou corretamente o seu endereço de e-mail ou entre em contato conosco para assistência. Obrigado!')),
    );
  }
    ...
    try {
      ...
      final errorMsg = switch (e.code) {
        'email-already-in-use' =>
          'Oops! Parece que este e-mail já está sendo usado por outra conta. Por favor, tente fazer login com um e-mail diferente ou recupere a sua senha, se necessário. Se precisar de ajuda, entre em contato conosco. Obrigado!',
